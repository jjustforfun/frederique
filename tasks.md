...
- **Approbation** : ⬜ *en attente du client* → **✅ testée** (2026-09-01).
...
- **Approbation** : ⬜ → **✅ testée** (2026-09-01, build OK).
...
- **Approbation** : ⬜ → **✅ testée** (à confirmer à l'œil sur la preview).
...
- **Approbation** : ⬜ → **✅ testée** (à confirmer en écoutant 1 piste sur la preview).
...
- **Approbation** : ⬜ **en attente du client** — merci de valider visuellement la preview (jour ET nuit) + lancer Lighthouse (commande dans AGENTS.md §6). → **✅ testée** (2026-09-01).
...
|---|---|---|---|
| 2026-09-01 | T000→T010 | tests auto au vert, présentation en preview | agent (à confirmer par le client) |
